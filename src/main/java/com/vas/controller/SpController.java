...
//        System.out.println("uddate Servce code==" + SERVICE_CODE);
        ...
        String msg = null;
        try {
            msg = dao.saveSp(SP_CODE, SP_NAME, SHORT_CODE, ADDRESS, CONTACT_PERSON,
            TEL_NO, MOBILE_NO, EMAIL, SLDG_CODE, PAN_NO, CONTRACT_DT,
            CONTRACT_TER_DT, SERVICE_START_DT, BANK_INFORMATION, USER);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
...
//        System.out.println("uddate Servce code==" + SERVICE_CODE);
        ...
        String msg = null;
        try {
            msg = dao.updateSp(SP_CODE, SP_NAME, SHORT_CODE, ADDRESS, CONTACT_PERSON,
            TEL_NO, MOBILE_NO, EMAIL, SLDG_CODE, PAN_NO, CONTRACT_DT,
            CONTRACT_TER_DT, SERVICE_START_DT, BANK_INFORMATION, USER);
        } catch (SQLException e) {
            // TODO Auto-generated catch block
