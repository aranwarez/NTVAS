...
public class CpDetailController {
	...
	public String cpdetaillist(String SP_CODE, String SERVICE_CODE, String CP_CODE, Locale locale, Model model)
			throws SQLException {
	...
	public List<Map<String, Object>> getCpDetaillist(String SP_CODE, String SERVICE_CODE, String CP_CODE, Locale locale,
	...
	@ResponseBody
	public String saveJSCpdetail(String CP_CODE, String RATE, String EFFECTIVE_DT, HttpSession session, Model model,
			Locale locale) {
...
//        System.out.println("uddate Servce code==" + SERVICE_CODE);
	...
	// getting rate list of all CP target
	@ResponseBody
	@RequestMapping(value = "/cpdetail/getCpRatelist", method = RequestMethod.GET)
	public List<Map<String, Object>> getCpRatelist(String CP_CODE, Locale locale, Model model, HttpSession session)
			throws SQLException {
		CpDetailDao dao = new CpDetailDao();
		return dao.getCpRateList(CP_CODE);
	}

	@RequestMapping(value = "/cpdetail/updateJS", method = RequestMethod.POST)
	@ResponseBody
	public String updateRate(String TRANS_ID, String CP_CODE, String RATE, String EFFECTIVE_DT, HttpSession session,
			Model model, Locale locale) {

		logger.info("Update content provider rate {}.", locale);
		CpDetailDao dao = new CpDetailDao();
		UserInformationModel userinfo = (UserInformationModel) session.getAttribute("UserList");
		String USER = userinfo.getUSER_ID();
		String msg = null;
		try {
			msg = dao.updateCpDetail(TRANS_ID, CP_CODE, RATE, EFFECTIVE_DT, USER);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	@RequestMapping(value = "/cpdetail/deleteJS", method = RequestMethod.POST)
	@ResponseBody
	public String deleteRate(String TRANS_ID, HttpSession session, Model model, Locale locale) {
