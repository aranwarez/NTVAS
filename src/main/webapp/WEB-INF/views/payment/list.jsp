...
<html>
    <head>
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        ...
                        <tr>  <c:forEach var="DAT" items="${Date_list}">
                                ...
                                <td>
                                    <input type="button" style="width: 150px;" value="QUERY" onclick="getPaymentFilterList();">    
                                </td>
                            </c:forEach>
                        </tr>
                    </table> 
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="btn btn-info" data-toggle="modal"
                                                               ...
                                                               onclick="return editPayment('${user.PAYMENT_NO}')"> <i
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="" class="btn btn-default" data-toggle="modal"
                                                               ...
                                                               onclick="return deletePayment('${user.PAYMENT_NO}')"> <i
       ...
       immediately after the control sidebar -->
        ...
        <jsp:include page="${request.contextPath}/dialogpayment"></jsp:include>
