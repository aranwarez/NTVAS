...
<html>
    <head>
                                        ...
                                        <tbody>
                                            <c:forEach var="user" items="${data_list}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>${user.CATEGORY_CODE}</td>
                                                    <td>${user.IS_RECURRING}</td>
                                                    <td>${user.TAXABLE_AMT}</td>
                                                    <td>${user.VATABLE_AMT}</td>
                                                    <td>${user.OWN_AMT}</td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="btn btn-info" data-toggle="modal"
                                                               ...
                                                               onclick="return editItem('${user.ITEM_CODE}')">
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a href="" class="btn btn-default" data-toggle="modal"
                                                               ...
                                                               onclick="return deleteItem('${user.ITEM_CODE}')">
       ...
       immediately after the control sidebar -->
        ...
        <jsp:include page="${request.contextPath}/dialogitem"></jsp:include>
        <jsp:include page="${request.contextPath}/footJS"></jsp:include>
            ...
            <script src="<c:url value="/resources/function/item.js" />"></script>
