...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<td>
													<div class="btn-group">
														<a href="#" class="btn btn-info" data-toggle="modal"
															...
															onclick="return editPackage('${user.PACKAGE_TYPE}')">
												...
												<td>
													<div>
														<a href="" class="btn btn-default" data-toggle="modal"
															...
															onclick="return deletePackage('${user.PACKAGE_TYPE}')">
	...
	<jsp:include page="${request.contextPath}/dialogpackage"></jsp:include>
	...
	<script src="<c:url value="/resources/function/package.js" />"></script>
