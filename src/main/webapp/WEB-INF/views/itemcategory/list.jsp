...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<td>
													<div class="btn-group">
														<a href="#" class="btn btn-info" data-toggle="modal"
															...
															onclick="return editItemCategory('${user.CATEGORY_CODE}')">
												...
												<td>
													<div>
														<a href="" class="btn btn-default" data-toggle="modal"
															...
															onclick="return deleteItemCategory('${user.CATEGORY_CODE}')">
	...
	<jsp:include page="${request.contextPath}/dialogitemcategory"></jsp:include>
	...
	<script src="<c:url value="/resources/function/itemcategory.js" />"></script>
