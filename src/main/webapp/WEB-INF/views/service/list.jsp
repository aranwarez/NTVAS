...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<td>
													<div class="btn-group">
														<a href="#" class="btn btn-info" data-toggle="modal"
															...
															onclick="return editService('${user.SERVICE_CODE}')">
												...
												<td>
													<div>
														<a href="" class="btn btn-default" data-toggle="modal"
															...
															onclick="return deleteService('${user.SERVICE_CODE}')">
	...
	<script src="<c:url value="/resources/function/service.js" />"></script>
