	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="../../index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				...
				<span class="logo-lg"><b>Nepal </b>Telecom</span>
			</a>
						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										NABIN- Web Developer <small>Member since Nov. 2012</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
									<div class="row">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<c:url value="/service/save" />" method="post"
					acceptCharset="UTF-8">

					<div class="modal-body">
						<div class="form-group">
							<label for="name">Service</label> <input type="text"
								class="form-control" name="SERVICE_CODE" placeholder="Enter Role">
