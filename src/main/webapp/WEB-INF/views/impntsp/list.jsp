    ...
    <head>
                    ...
                    <section class="content-header">
                        ...
                        <table>
                            ...
                            <c:forEach var="DAT" items="${Date_list}">
                                <td>  Year </td>
                                <td>
                                    <input style="width: 80px;" class="form-control" value="${DAT.CUR_YEAR}" type="number" name="QIMP_YEAR" id="QIMP_YEAR"
                                           placeholder="Enter Year"> 
                                </td>
                                <td>Period</td>
                                <td>
                                    <select style="width: 100px;" value="${DAT.CUR_PERIOD} class="form-control" name="QIMP_PERIOD" id="QIMP_PERIOD">
                                ...
                                <td>
                                    <select  style="width: 200px;" name="QIMP_MONTH" id="QIMP_MONTH" > 
                                        <option value=''>Select :</option>
                                        <c:forEach var="MONTH" items="${Mon_list}">
                                            <c:if test = "${DAT.CUR_MONTH==MONTH.MONTH_CD}">
                                                <option selected value="${MONTH.MONTH_CD}"> ${MONTH.NEP_MONTH} </option></c:if>
                                            <c:if test = "${DAT.CUR_MONTH!=MONTH.MONTH_CD}">
                                                <option value="${MONTH.MONTH_CD}"> ${MONTH.NEP_MONTH}</option></c:if>
                                        </c:forEach>
                                    </select>
                                </td>
                            </c:forEach>    
                            ...
                            <td>NT/SP</td>      
                            <td>
                                <select style="width: 80px;" class="form-control" name="QNT_SP" id="QNT_SP">
                            ...
                            <td>Post</td>      
                            <td>
                                <select style="width: 80px;" class="form-control" name="QPOST_FLAG" id="QPOST_FLAG">
                            ...
                            <td>File Name</td>      
                            <td>
                                <input style="width: 280px;" class="form-control" name="QFILE_NAME" id="QFILE_NAME"
                                       placeholder="Press button select to import form excel File"> 
                            </td>                  
                            <td>
                                <input type="button" value="Select" onclick="getCpFilterList();">    
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="button" value="Query" onclick="getImpNtspFilterList();">    
                            </td>
                            <td>
                                <input type="button" value="Import Data" onclick="getCpFilterList();">    
                            </td>
                            <td>
                                <input type="button" value="Post" onclick="getCpFilterList();">    
                            </td>
                            <td>
                                <input type="button" value="Delete" onclick="getCpFilterList();">    
                            </td>
                        </tr>
                    </table> 
       ...
       immediately after the control sidebar -->
        ...
        <jsp:include page="${request.contextPath}/footJS"></jsp:include>
            ...
            <script src="<c:url value="/resources/function/impntsp.js" />"></script>
