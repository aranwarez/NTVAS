    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">New Stream Type Define</h4>
            </div>

            <div class="modal-body">
                <div class="form-group">
                    <label for="name">STREAM_TYPE</label> <input type="text"
                                                                  class="form-control" name="STREAM_TYPE" id="STREAM_TYPE" placeholder="Enter Stream Type">
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" onclick="saveStream()">Save changes</button>
            </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<c:url value="/stream/update" />" method="post"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">STREAM_TYPE</label>
                        <input type="text" class="form-control" name="STREAM_TYPE" id="EDITSTREAM_TYPE" placeholder="Enter Stream" readonly="readonly">
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" onclick="return updateStream();" class="btn btn-primary">Update</button>
                </div>
