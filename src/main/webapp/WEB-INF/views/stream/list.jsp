...
<body class="hold-transition skin-blue sidebar-mini">
												...
												<td>
													<div class="btn-group">
														<a href="#" class="btn btn-info" data-toggle="modal"
															...
															onclick="return editStream('${user.STREAM_TYPE}')"> <i
												...
												<td>
													<div>
														<a href="" class="btn btn-default" data-toggle="modal"
															...
															onclick="return deleteStream('${user.STREAM_TYPE}')">
	...
	<jsp:include page="${request.contextPath}/dialogstream"></jsp:include>
	...
	<script src="<c:url value="/resources/function/stream.js" />"></script>
