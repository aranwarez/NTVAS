...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						...
						<select id="REGION_CODE" onchange="return getAccountCenter()"
							class="form-control">
                            ...
                            <select id="ACC_CEN_CODE" class="form-control" onchange="return getCC()">
                                <option></option>
                            </select>
	...
	<jsp:include page="${request.contextPath}/dialogcc"></jsp:include>
	...
	<script src="<c:url value="/resources/function/cc.js" />"></script>
