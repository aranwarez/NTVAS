...
<html>
    <head>
        ...
        <body class="hold-transition skin-blue sidebar-mini">
            <div class="wrapper">
                ...
                <div class="content-wrapper">
                    ...
                    <c:if test="${MENU_ACCESS.getADD_FLAG()=='Y'}">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <!-- /.box-header -->
                                <div id="jsdiv" class='box-body table-responsive'></div>
                                <div id="querydiv" class="box-body table-responsive">
       ...
       immediately after the control sidebar -->
        ...
        <jsp:include page="${request.contextPath}/dialogNetting"></jsp:include>
