...
<!-- main Post Netting to bill  dialog box -->

<div class="modal fade" id="mainpostdialog" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Invoice Creation </h4>
            </div>

            <div class="modal-body">
                <p>Are you sure? you want to Generate Invoice for given selection criteria.</p>
            </div>

            <div class="modal-footer">

                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                <button type="button" class="btn btn-primary"  onclick="mainbillpost();">Yes</button>
