		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					</select> <label for="ContractDt">Contract Dt.</label> <input type="text"
						class="form-control" name="CONTRACT_DT" id="CONTRACT_DT"
						placeholder="Enter Contract Dt."> <label for="TerminateDt">Terminate
						Dt.</label> <input type="text" class="form-control" name="CONTRACT_TER_DT"
						id="CONTRACT_TER_DT" placeholder="Enter Contract Terminate Dt.">
				...
				<h4 class="modal-title" id="myModalLabel">Edit Service Provider</h4>
					...
					<div class="form-group">
						...
						<label for="TelNo">Tel No.</label> <input type="text"
							...
							class="form-control" name="CONTRACT_DT" id="EDITCONTRACT_DT"
							placeholder="Enter Contract Dt."> <label
							for="TerminateDt">Terminate Dt.</label> <input type="text"
							class="form-control" name="CONTRACT_TER_DT"
							id="EDITCONTRACT_TER_DT"
							placeholder="Enter Contract Terminate Dt.">
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
