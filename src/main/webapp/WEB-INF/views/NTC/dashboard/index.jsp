...
<title>Nepal Telecom | Dashboard</title>
...
<link href="<c:url value="/resources/adminltd/css/morris.css" />"
	rel="stylesheet">
...
<body class="hold-transition skin-blue sidebar-mini">
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="<c:url value="/resources/adminltd/dist/img/user2-160x160.jpg" />"
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="<c:url value="/resources/adminltd/dist/img/user3-128x128.jpg" />"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="<c:url value="/resources/adminltd/dist/img/user4-128x128.jpg" />"
														class="img-circle" alt="User Image">
												</div>
												<h4>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="<c:url value="/resources/adminltd/dist/img/user2-160x160.jpg" />" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="<c:url value="/resources/adminltd/dist/img/user2-160x160.jpg" />" class="img-circle"
									alt="User Image">
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="<c:url value="/resources/adminltd/dist/img/user2-160x160.jpg" />" class="img-circle"
							alt="User Image">
					</div>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="chartjs.html"><i class="fa fa-circle-o"></i>
									ChartJS</a></li>
							<li class="active"><a href="morris.html"><i
									class="fa fa-circle-o"></i> Morris</a></li>
							<li><a href="flot.html"><i class="fa fa-circle-o"></i>
									Flot</a></li>
							<li><a href="inline.html"><i class="fa fa-circle-o"></i>
									Inline charts</a></li>
						</ul></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="callout callout-warning">
					...
					<p>
						<b>Morris.js</b> charts are no longer maintained by its author. We
						would recommend using any of the other charts that come with the
						template.
					</p>
				</div>
				<div class="row">
	...
	<script src="<c:url value="/resources/adminltd/js/raphael.min.js" />"></script>


	<script src="<c:url value="/resources/adminltd/js/morris.min.js" />"></script>
	...
	<!-- AdminLTE for demo purposes -->
		...
		<script src="<c:url value="/resources/adminltd/js/demo.js" />"></script>
	<!-- page script -->
	<script>
		$(function() {
			"use strict";
