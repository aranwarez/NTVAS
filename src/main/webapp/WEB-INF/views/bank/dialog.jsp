			...
			<div class="modal-body">
				<div class="form-group">
					...
					<label for="name">DESCRIPTION</label> <input type="text"
						...
						class="form-control" name="DESCRIPTION" id="ADDRESS"
						placeholder="Enter Address">
						<label for="name">Account No</label> <input type="text"
						class="form-control" name="DESCRIPTION" id="ACCTNO"
						placeholder="Enter Account No.">
						<label for="name">Account Type</label> <input type="text"
						class="form-control" name="DESCRIPTION" id="ACCTYPE"
						placeholder="Enter Type">
						<label for="name">Active FLAG</label> <select class="form-control" id="ACCTFLAG"><option value="T">Y</option>
						<option value="N">N</option></select>
						<label for="name">Deactive Date</label> <input type="text"
						class="nepali-calendar form-control" name="DESCRIPTION" id="DEACTIVE_DT">
										</div>
			</div>
